...
def test_meetup():
    ...
    expected = {'titolo': 'Esperanto-Toronto: Socia kunveno',
                'urbo': 'Toronto',
...
def test_duolingo():
    ...
    expected = {'titolo': 'Guadalajara Esperanto: Tria renkontiĝon',
                ...
                'enhavo': 'Vamos a tener otra reunión, esta vez vamos a hablar sobre el futuro '
                          ...
                          ' Cualquier nivel es bienvenido', 'priskribo': 'Saluton al ĉiuj. '
